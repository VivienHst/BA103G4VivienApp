...
public class StoreContFragment extends Fragment{
...
//        }
    ...
    private class ProductCardAdapter extends
            RecyclerView.Adapter<StoreContFragment.ProductCardAdapter.MyViewHolder> {
        ...
        @Override
        public StoreContFragment.ProductCardAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(context);
            View itemView = layoutInflater.inflate(R.layout.store_card_item, viewGroup, false);
            return new StoreContFragment.ProductCardAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(StoreContFragment.ProductCardAdapter.MyViewHolder viewHolder, int position) {
