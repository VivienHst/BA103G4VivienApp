...
//        List<Ord_listVO> getOrderList(String ord_no){
//            List<Ord_listVO> ordList = new ArrayList<>();
//
//            if(networkConnected()){
//                retriveOrdTask = new RetrieveOrdListTask().execute(Common.ORD_URL, ord_no);
//
//                try {
//                    ordList = (List) retriveOrdTask.get();
//                } catch (InterruptedException e) {
...
//        class RetrieveOrdListTask extends AsyncTask<String, Void, List<Ord_listVO>>{
//
//            @Override
//            protected List<Ord_listVO> doInBackground(String... param) {
//                String url = param[0];
//                String ord_no = param[1];
//                String jsonIn;
//                JsonObject jsonObject = new JsonObject();
//                jsonObject.addProperty("action", "getOrd_listByOrd");
